...
const LEGAL = {
  appName: 'Carevie',
  companyLegalName: 'Carevie Technologies Private Limited', // <-- replace with your actual legal entity name
  contactEmail: 'hello@carevie.com', // <-- replace with your official support/legal email
  grievanceEmail: 'hello@carevie.com', // <-- can be same as contactEmail
